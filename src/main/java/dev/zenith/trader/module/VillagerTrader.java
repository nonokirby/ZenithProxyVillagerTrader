...
public class VillagerTrader extends Module {
    ...
    private boolean villagerNameContains(EntityLiving villager, String contains, Boolean check) {
        ...
        return nameString.toLowerCase().contains(contains.toLowerCase()) && check;
    }
